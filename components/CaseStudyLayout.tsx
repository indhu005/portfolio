        ...
        >
          {caseStudy.sections.map((section, index) => (
            ...
            >
              ...
              {/* Visual Content Area - Hidden for strategy, constraints, tradeoffs, context-problem, turning-point, snapshot, problem, and reflection sections */}
              {section.id !== 'strategy' && section.id !== 'constraints' && section.id !== 'tradeoffs' && section.id !== 'context-problem' && section.id !== 'turning-point' && section.id !== 'snapshot' && section.id !== 'problem' && section.id !== 'reflection' && (
                <div style={{
                  width: '100%',
                  minHeight: '500px',
