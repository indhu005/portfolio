        ...
        >
          ...
          {caseStudy.sections.map((section, index) => (
            ...
            >
              ...
              {/* Visual Content Area - Hidden for strategy, constraints, tradeoffs, context-problem, turning-point, snapshot, problem, research, reflection, and started sections, and for sections that already embed real media via customComponent */}
