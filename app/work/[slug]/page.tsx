  ...
  <video autoplay loop muted playsinline preload="auto" style="width: 100%; max-width: 300px; aspect-ratio: 580 / 1040; border-radius: 8px; display: block; object-fit: cover;">
    ...
    Your browser does not support the video tag.
      ...
      },
      {
        ...
        content: `<p>TrueMedia.org was a nonprofit building deepfake detection for the 2024 election cycle. Through UW's partnership structure I contributed research synthesis — what to prioritize, what behaviors to design for. Their product shipped later in 2024: a dark, utilitarian interface for journalists and researchers. Mine served the opposite audience, a teenager at Ballard High asking "why should I care?" Two valid solutions to adjacent problems.</p>

<p style="margin-top: 28px;">What happened to TrueMedia matters more than the collaboration itself. They analyzed 60,000+ pieces of media, launched publicly in September 2024, and shut down in January 2025 — open-sourcing the technology rather than chasing funding. Founder Oren Etzioni: "As a society, we are not prepared for a large-scale, concerted, generative AI attack. It did not materialize in 2024. That doesn't mean it's not coming."</p>

<p style="margin-top: 28px;">Two lessons reframed how I think about this market. First: platforms are ambivalent about deepfake detection because deepfakes drive engagement and community fact-checking is nearly free — the pilot budget a leading platform gave TrueMedia was a fraction of what's spent on training data elsewhere. The real unaddressed threat was personalized scams, content that never reaches a community to be verified. Second: detection is the expensive end of the chain. Authenticating content at creation — watermarking, provenance — is more efficient, but C2PA proposed exactly this and stalled: no incentives, no champions. That gap isn't a design problem. It's economic. Design can't solve it. Policy might.</p>`
      },
      {
        id: 'reflection',
        title: '07 — Reflection',
        ...
        content: `<p><span style="font-weight: 600;">What this project taught me that comfortable work couldn't.</span> Keye taught me to treat design decisions as hypotheses. This project taught me something harder: no matter how well-designed a product is, design alone cannot make a public good sustainable. TrueMedia was research-grounded, mission-complete, and it still closed. The design wasn't the problem. The economics were. The most important design question for any public good isn't "what should this look like." It's "what does this attach to that keeps it viable?" The compass is trusted because it has no business model, and it exists because the phone manufacturer absorbs the cost. That's why the integration vision (Apple News, the share sheet, the native camera) isn't a nice-to-have in this case study. It's the sustainability answer.</p>
