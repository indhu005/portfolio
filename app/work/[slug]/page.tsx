...
<div id="prototype" class="figma-embed-container" style="margin-top: 48px; position: relative;">
  <div class="figma-embed-iframe figma-embed-placeholder" data-figma-src="https://embed.figma.com/proto/5SuxUGsaCvOVUiRdXa7uNl/Misinformation-Center?page-id=12%3A7585&node-id=20-3800&p=f&viewport=1079%2C560%2C0.06&scaling=scale-down&content-scaling=fixed&starting-point-node-id=20%3A3748&show-proto-sidebar=1&embed-host=share" style="border: 1px solid rgba(0, 0, 0, 0.1); border-radius: 8px; width: 100%; background-color: #F3F4F6; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; cursor: pointer;">
    <div class="figma-embed-play" style="width: 56px; height: 56px; border-radius: 50%; background-color: #1C1917; display: flex; align-items: center; justify-content: center;">
    ...
    <div class="figma-embed-label" style="font-weight: 600; font-size: 15px; color: #1C1917;">Click to load the interactive prototype</div>
